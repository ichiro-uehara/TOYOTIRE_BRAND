...
Friend Class F_HZDELE
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
        ...
        result = hz_search(form_no.w_no1.Text, form_no.w_no2.Text, 0)
        If result = FAIL Then
		...
		If w_ret = MsgBoxResult.Yes Then
			init_sql()
            result = hz_delete(Trim(w_no1.Text), Trim(w_no2.Text))
            If result = FAIL Then
                MsgBox("Failed to delete the Editing characters drawing.", 64, "Delete error")
            Else
                MsgBox("Removed the Editing characters drawing.")
                'POKE送信->ACAD（図面名）
                w_mess = HensyuZumenDir & "HE-" & Trim(w_no1.Text) & "-" & Trim(w_no2.Text)
	...
	Private Sub F_HZDELE_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim w_ret As Object
		Dim i As Object
		Dim lp As Object
		Dim aa As String
	...
	Private Sub w_no1_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles w_no1.KeyPress
		...
		If KeyAscii = 9 Or KeyAscii = 10 Or KeyAscii = 13 Then
            ...
            If result = False Then
                MsgBox("There is no Editing characters drawing.", MsgBoxStyle.Critical, "error")
            Else
                dataset_F_HZDELE()
            End If
