...
Friend Class F_GZLOOK
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
		...
		If Len(w_no1.Text) = 4 Then
			...
			result = gz_search(form_no.w_no1.Text, form_no.w_no2.Text, 1)
			If result = FAIL Then
	...
	Private Sub F_GZLOOK_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim w_ret As Object
		Dim i As Object
        ...
        '    form_no.MSFlexGrid1.set_RowHeight(lp, 30) '変換後
        'Next lp
